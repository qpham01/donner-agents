...
if __name__ == "__main__":
    account = Account(name="Quoc", balance=10000, strategy="Buy and Hold", holdings={}, transactions=[], portfolio_value_time_series=[])
    account.deposit(1000)
    account.buy_shares("AAPL", 5, "Buying AAPL")
    account.sell_shares("AAPL", 2, "Selling AAPL")
